...
@InputType()
class AppointmentCreateNestedManyWithoutPatientsInput {
...
export { AppointmentCreateNestedManyWithoutPatientsInput as AppointmentCreateNestedManyWithoutPatientsInput };
