...
@InputType()
class InvoiceItemCreateNestedManyWithoutTreatmentsInput {
...
export { InvoiceItemCreateNestedManyWithoutTreatmentsInput as InvoiceItemCreateNestedManyWithoutTreatmentsInput };
