...
@InputType()
class AppointmentCreateNestedManyWithoutProfessionalsInput {
...
export { AppointmentCreateNestedManyWithoutProfessionalsInput as AppointmentCreateNestedManyWithoutProfessionalsInput };
