...
@InputType()
class ProfessionalCreateNestedManyWithoutClinicsInput {
...
export { ProfessionalCreateNestedManyWithoutClinicsInput as ProfessionalCreateNestedManyWithoutClinicsInput };
