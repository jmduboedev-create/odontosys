...
@InputType()
class AppointmentCreateNestedManyWithoutClinicsInput {
...
export { AppointmentCreateNestedManyWithoutClinicsInput as AppointmentCreateNestedManyWithoutClinicsInput };
