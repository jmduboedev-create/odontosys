...
@InputType()
class InvoiceItemUpdateManyWithoutDentalProceduresInput {
...
export { InvoiceItemUpdateManyWithoutDentalProceduresInput as InvoiceItemUpdateManyWithoutDentalProceduresInput };
