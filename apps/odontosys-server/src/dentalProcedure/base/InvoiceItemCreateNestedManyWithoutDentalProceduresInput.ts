...
@InputType()
class InvoiceItemCreateNestedManyWithoutDentalProceduresInput {
...
export { InvoiceItemCreateNestedManyWithoutDentalProceduresInput as InvoiceItemCreateNestedManyWithoutDentalProceduresInput };
